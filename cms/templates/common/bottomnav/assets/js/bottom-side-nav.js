...
sidenav.innerHTML = `<div id="hello" onclick="change()"><span id="cur">${current}</span> <img id="dropup-button" style="margin-left: 10px" src="./assets/images/right.png"></div>`;
...
const change = () => {
  ...
  if (!open) {
    ...
    content_a[0].addEventListener("transitionend", () => {
